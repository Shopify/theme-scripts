...
describe("request()", () => {
  ...
  describe("200", () => {
    it("valid", () => {
      ...
      request(null, "config=foo", "foo-200", spyOnSucess);
    ...
    it("valid with locale search route", () => {
      ...
      request('/pt-pt/search/suggest.json', "config=foo", "foo-200", spyOnSucess);
    ...
    it("fails on invalid JSON", done => {
      ...
      request(null, "config=foo", "foo-200-invalid", null, error => {
  ...
  describe("4xx", () => {
    it("404", done => {
      ...
      request(null, "config=foo", "foo-404", null, error => {
        expect(error).toBeInstanceOf(Error);
    ...
    describe("422", () => {
      it("valid", done => {
        ...
        request(null, "config=foo", "foo-422", null, error => {
          expect(error).toBeInstanceOf(Error);
      ...
      it("invalid JSON", done => {
        ...
        request(null, "config=foo", "foo-422-invalid", null, error => {
          expect(error).toBeInstanceOf(Error);
          expect(error.status).toBe(422);
    ...
    describe("429", () => {
      it("valid", done => {
        ...
        request(null, "config=foo", "foo-429", null, error => {
          expect(error).toBeInstanceOf(Error);
      ...
      it("invalid JSON", done => {
        ...
        request(null, "config=foo", "foo-429-invalid", null, error => {
          expect(error).toBeInstanceOf(Error);
          expect(error.status).toBe(429);
          expect(error.name).toBe("JSON parse error");
          done();
    ...
    describe("417", () => {
      it("head request", done => {
        ...
        request(null, "config=foo", "foo-417", null, error => {
          expect(error).toBeInstanceOf(Error);
  ...
  describe("500", () => {
    it("head request", done => {
      ...
      request(null, "config=foo", "foo-500", null, error => {
        expect(error).toBeInstanceOf(Error);
