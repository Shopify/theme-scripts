...
export function validate(product) {
  if ((typeof product === 'undefined' ? 'undefined' : _typeof(product)) !== 'object' || typeof product.id !== 'number') {
...
export function getVariant(product, value) {
  ...
  } else if ((typeof value === 'undefined' ? 'undefined' : _typeof(value)) === 'object' && typeof value.id === 'number') {
